...
Choose a pixel image converter to convert your chosen image into pixelated form. Have m and n be the resolution of you OLED(NHD 2.8 will use a 256x64 converter, for example). Save the resulting image. 
